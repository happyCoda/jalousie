...
_jquery2.default.fn.jalousie = function (params) {
  ...
  this.append((0, _jquery2.default)(docFrag));

  (0, _jquery2.default)('.shutter').animate({ width: Math.ceil(imgWidth / shutterNum) + 'px' }, params.duration || 3000);
}; /*
...
(0, _jquery2.default)('.container').jalousie({
  shutterNum: 5,
